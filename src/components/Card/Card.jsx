...
export default function Card(card) {
  ...
  return (
    <div className="card">
      ...
      />
      <div className='p-5'>
        <h3 className="Product-title" title={card.name}>
          {card.name}
        </h3>

        <p className="text-xl font-bold">Precio: U$S {card.precio}</p>

        <div className="flex items-center gap-2 mt-1">
          <span class="text-sm line-through opacity-50">U$S 59.99</span>
        ...
        <div className="py-5 flex-col gap-3">
          <div className="flex items-center gap-2">
            ...
            <p className="badge">{card.categorias}</p>
          </div>
